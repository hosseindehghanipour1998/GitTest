...
First it's good to mention that we are going to use _Terminal_ to run some commands in order to install some files.
  ...
  3. Now we should install ___"Create React App"___ by simply saying : `npm install -g create-react-app` <br/>
    1. We can test _"Create React App"_  version wtih : `create-react-app --version`
